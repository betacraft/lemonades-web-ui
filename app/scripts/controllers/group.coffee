...
.controller('GroupCtrl',
  ['$scope', '$cookies', '$cookieStore', '$http', '$rootScope', '$routeParams', '$location', 'ngToast', '$window',
   '$filter', '$anchorScroll', '$sce',
    ($scope, $cookies, $cookieStore, $http, $rootScope, $routeParams, $location, ngToast, $window, $filter, $anchorScroll, $sce) ->
      $scope.htmlReady();
